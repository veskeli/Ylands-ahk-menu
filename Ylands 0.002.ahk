...
picsfol = %A_ScriptDir%\Ylands files\pics


;ini read shit
IniRead, borderless , %Settingsini%
...
"Shift + Q" Mouse 2 spammer(toggle)
"Shift + P" Auto planter
"Numpad *" Auto run(Toggle)
"Shift + F" Auto smelter filler
"Shift + R" Auto craft(Smeltter's jne..)
)
;---------------------------------------------------------------------------------------------------------------------------------
;---------------------------------------------------------------------------------------------------------------------------------
Loop
...
Gui Tab, 2
Gui Font, s20
Gui Add, Button, x1243 y690 w117 h45, Save
Gui Font
...
Gui Add, CheckBox, x440 y56 w189 h23, Ylands menu(currently not working)
Gui Add, Text, x432 y704 w120 h23 +0x200, windowed borderless
Gui Add, Button, x552 y704 w80 h23 gborderlesstogg, Toggle
Gui Add, CheckBox, x720 y704 w120 h23 , Auto ON(currently not working)
